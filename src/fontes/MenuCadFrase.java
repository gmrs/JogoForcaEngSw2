 ...
 * @author Guilherme
 */
public class MenuCadFrase extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        user_word.setText("INFORME UMA FRASE");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (temp.length() <= 1)
        {
            ...
            if (user_word.getText().length()-user_word.getText().replaceAll(" ","").length() < 1)
                JOptionPane.showMessageDialog(null, "Informe uma frase. Necessita ter pelo menos um espaço!", "Aviso", JOptionPane.ERROR_MESSAGE);
            else{
                if((user_word.getText().charAt(0) == ' ') || (user_word.getText().charAt(user_word.getText().length()-1) == ' ')){
                    JOptionPane.showMessageDialog(null, "A frase não pode iniciar ou terminar com espaços!", "Aviso", JOptionPane.ERROR_MESSAGE);
                }
                else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuCadFrase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuCadFrase().setVisible(true);
            }
        });
    }
